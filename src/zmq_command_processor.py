...
class ZMQCommandProcessor:
    ...
    def _cmd_set_rendering_mode(self, data: dict) -> dict:
        ...
        if mode_name not in mode_map:
            return {
                "success": False,
                "message": f"Unknown mode: {mode_name}. Valid: {list(mode_map.keys())}",
            }
        ...
        return {
            "success": True,
            "message": f"{target} rendering mode set to {mode_name.upper()}",
        }
    ...
    def _cmd_set_transfer_function(self, data: dict) -> dict:
        ...
        if tf_name not in self.app_core.tf_names:
            return {
                "success": False,
                "message": f"Unknown TF: {tf_name}. Valid: {self.app_core.tf_names}",
            }
        ...
        return {
            "success": True,
            "message": f"{target} transfer function set to {tf_name}",
        }
    ...
    def _cmd_rotate(self, data: dict) -> dict:
        ...
        return {
            "success": True,
            "message": f"Rotated {axis.upper()} by {degrees} degrees",
        }
    ...
    def _cmd_set_fov(self, data: dict) -> dict:
        ...
        return {
            "success": True,
            "message": f"FOV set to {self.app_core.camera.fov:.1f} degrees",
        }
    ...
    def _cmd_set_slice(self, data: dict) -> dict:
        ...
        if axis not in axis_map:
            return {
                "success": False,
                "message": f"Invalid axis: {axis}. Use x, y, or z",
            }
    ...
    def _cmd_set_lighting(self, data: dict) -> dict:
        ...
        if mode_name not in mode_map:
            return {
                "success": False,
                "message": f"Unknown lighting mode: {mode_name}. Valid: {list(mode_map.keys())}",
            }
    ...
    def _cmd_set_quality(self, data: dict) -> dict:
        ...
        return {
            "success": True,
            "message": f"Quality set to {self.app_core.sampling_rate}x",
        }
    ...
    def _cmd_crop(self, data: dict) -> dict:
        ...
        try:
            ...
            return {
                "success": False,
                "message": f"Invalid crop range: {range_str}. Use 'min,max'",
            }
        ...
        return {
            "success": True,
            "message": f"Crop {axis.upper()} set to [{c_min:.2f}, {c_max:.2f}]",
        }
    ...
    def _cmd_set_specular(self, data: dict) -> dict:
        ...
        return {
            "success": True,
            "message": f"Specular set to {self.app_core.specular_intensity:.2f}",
        }
    ...
    def _cmd_set_shininess(self, data: dict) -> dict:
        ...
        return {
            "success": True,
            "message": f"Shininess set to {self.app_core.shininess:.1f}",
        }
    ...
    def _cmd_set_gradient_weight(self, data: dict) -> dict:
        ...
        return {
            "success": True,
            "message": f"Gradient weight set to {self.app_core.gradient_weight:.1f}",
        }
